...
function doesFriendExist(ageInText, ageInNumber) {
    if (ageInText == 'NaN' && ageInNumber != 'NaN' || ageInText == 'NaN' && ageInNumber == 'NaN' || ageInText == 'NaN' && typeof (ageInNumber) == 'string') {
        return (ageInText);
    }
    else
        return ageInNumber;
...
function sweetTooth(totalNoOfSweets, sweetsConsumedByKaren, sweetsConsumedInNMeters, metersToTravel) {
    ...
    else if (totalNoOfSweets != Number || sweetsConsumedByKaren != Number || sweetsConsumedInNMeters != Number || metersToTravel != Number) {
        return ("No sweets for Karen's friend");
    }
    else {
